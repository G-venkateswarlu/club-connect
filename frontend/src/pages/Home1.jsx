...
//             Welcome to Sastra Club Connect
//           </h1>
...
export default function Home() {
  ...
  return (
    <div  className="relative w-full min-h-[100dvh] bg-center bg-cover"
      >
      {/* Background image */}
      <img
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-white">
        ...
        >
          ...
          <p className="text-lg max-w-xl mx-auto animate-fade-in">
            Share your ideas, club initiatives, internships and academic resources. Choose how you'd like to get started.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col items-center gap-8">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="cursor-pointer bg-white/70 text-black rounded-3xl shadow-xl p-6 w-[280px] flex flex-col items-center hover:scale-105 transition-transform duration-300 hover:shadow-blue-400/50"
              onClick={() => navigate('/student/login')}
            >
              <UserRoundPen className="text-blue-600 text-5xl mb-4" />
              <h2 className="text-xl font-bold mb-4 text-blue-700">Student Login</h2>
          ...
          <div className="flex flex-col items-center gap-8">
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="cursor-pointer bg-white/70 text-black rounded-3xl shadow-xl p-6 w-[280px] flex flex-col items-center hover:scale-105 transition-transform duration-300 hover:shadow-purple-400/50"
              onClick={() => navigate('/club/login')}
            >
              <UserRoundPen className="text-purple-600 text-5xl mb-4" />
              <h2 className="text-xl font-bold mb-4 text-purple-700">Club Login</h2>
